...
import maincategory from './categories.json';
    ...
    },
    {
      ...
      fields: {
        ...
        regular: {
          ...
          name: 'expenses',
          label:
            'Do you have any regular expense? If yes, what type and amount?',
          value: '',
          validations: ['required'],
          options: _.chain(maincategory.subcategory)
            .filter({ typeCode: 'expense' })
            .filter((r) => r.categoryCode !== 'loan')
            .map((category: any) => {
